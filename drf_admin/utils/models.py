...
class BaseModel(models.Model):
    ...
    # created_by = models.IntegerField(null=True,verbose_name='创建人',default=0)
    # modify_by = models.IntegerField(null=True,verbose_name='修改人',default=0)

    # 0:启用 1:禁用
    state = models.IntegerField(null=False,default=0,verbose_name='禁用状态')
